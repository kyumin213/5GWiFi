...
var BLACK_STYLE =    //黑色风格
{
    ...
    SelectRectBGColor:"rgb(1,130,212)", //背景色
    //   this.SelectRectAlpha=0.06;                  //透明度

    UpBarColor: "rgb(37,175,142)",
    DownBarColor: "rgb(210,73,99)",
    ...
    DefaultTextColor: "rgb(238, 238, 238)",
    DefaultTextFont: '14px 微软雅黑',

    DynamicTitleFont: '12px 微软雅黑', //指标动态标题字体


    UpTextColor: "rgb(37,175,142)",
    DownTextColor: "rgb(210,73,99)",
    UnchagneTextColor: "rgb(238, 238, 238)",
    CloseLineColor: 'rgb(178,34,34)',

    FrameBorderPen:"rgba(255, 255, 255,0)",     //边框
    FrameSplitPen: "rgba(238, 238, 238,.5)",          //分割线
    FrameSplitTextColor: "rgb(238, 238, 238)",     //刻度文字颜色
    FrameSplitTextFont: "9px 微软雅黑",        //坐标刻度文字字体
    FrameTitleBGColor: "rgb(246,251,253)",      //标题栏背景色
    Frame: { XBottomOffset: 0 },   //X轴文字向下偏移

    FrameLatestPrice: {
        TextColor: 'rgb(255,255,255)',   //最新价格文字颜色
        UpBarColor: "rgb(37,175,142)",    //上涨
        DownBarColor: "rgb(210,73,99)",   //下跌
    ...
    CorssCursorHPenColor: "rgba(238, 238, 238,.5)",           //十字光标线段颜色
    CorssCursorVPenColor: "rgba(238, 238, 238,.5)",           //十字光标线段颜色

    KLine:
    {
        MaxMin: { Font: '14px 微软雅黑', Color: 'rgb(111,111,111)' },   //K线最大最小值显示
        Info:  //信息地雷
        {
    ...
    Index: {      //指标线段颜色
      ...
      NotSupport: { Font: "14px 微软雅黑", TextColor: "rgb(238, 238, 238)" }
    },
